...
const profile = join(root, '.tmp-chrome-reel-debug');
const port = Number(process.env.DEBUG_PORT || 9223);
const url = process.env.REEL_URL || 'http://127.0.0.1:8099/?quality=high';
const outFile = join(root, 'social', 'eteria-robotics-studio-reel.webm');
